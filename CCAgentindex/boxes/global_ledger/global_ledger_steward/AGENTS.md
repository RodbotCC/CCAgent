# Global Ledger Steward — Sub-Agent Configuration

Status: active v0.1
Suggested repo path: `LEDGERS/AGENTS/global_ledger_steward/AGENTS.md`
...
With explicit write permission, this agent may apply those edits in the working tree. The Comeketo app runtime grants local write authority only through `CCAgentindex/agents/global_ledger_steward/prompt.md`; GitHub pushes still require explicit human go-ahead.
