...
Status: active v0.2 (unified Box pattern, ATOM-2026-04-30-0044)
Canonical steward package: `LEDGERS/BOXES/global_ledger/steward/` (per DEC-2026-04-30-004)
Legacy runtime path (still live during migration window): `CCAgentindex/agents/global_ledger_steward/`
Box manifest: `LEDGERS/BOXES/global_ledger/box.json`
Box orientation: `LEDGERS/BOXES/global_ledger/BOX.md`
...
Resolution helper: `server.py _agent_resolve_prompt` (added in ATOM-2026-04-30-0029) — checks legacy path first, then unified Box. While both paths exist, dispatches resolve to legacy. Migration completes when legacy is retired.
