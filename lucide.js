/* Comeketo Agent — minimal Lucide icon set, inlined.
   Lucide is MIT licensed. Only the icons used in the app ship here.
   Usage in JSX: <Icon name="sun" size={16} />
*/
window.LucidePaths = {
  ...
  "briefcase": '<rect width="20" height="14" x="2" y="6" rx="2"/><path d="M16 6V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/><path d="M2 13h20"/>',
  ...
  "activity": '<path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.5.5 0 0 1-.96 0L10.2 3.18a.5.5 0 0 0-.96 0l-2.1 8.36A2 2 0 0 1 5.2 13H2"/>',
  ...
  "layers": '<path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z"/><path d="m22 12.18-9.17 4.18a2 2 0 0 1-1.66 0L2 12.18"/><path d="m22 17.18-9.17 4.18a2 2 0 0 1-1.66 0L2 17.18"/>',
...
// Usable as a React component. Declared on window so Babel-in-browser picks it up.
window.Icon = function Icon({ name, size = 16, strokeWidth = 1.75, color, style = {}, className }) {
  const paths = window.LucidePaths[name];
